...
<layer_1_quick_start>
  ...
  <error_escalation>
    **IF 3 consecutive fix attempts fail for the same issue:**
    ...
    - Read and follow instructions in `C:\Godot\AISpace\.windsurf\rules\StableOrOther\BugInvestigation.md`.
...
<layer_2_detailed_guide>
  ...
  <core_rules>
    ...
    <rule>
      ...
      <rationale>Future-proof design prevents technical debt. Use generic abstractions and parameterized logic.</rationale>
    </rule>
    <rule>
      <description>Store ALL rules, steering files, and architecture documents EXCLUSIVELY in AISpace/.</description>
