...
- **当前脚本**: `AISpace/.kiro/CloudSync_Workflow/kiro_sync_to_drive.py`
- **原始计划**: `AISpace/.kiro/CloudSync_Workflow/REFACTOR_PLAN.md` (已过时，保留作为历史记录)
- **主规则文件**: `AISpace/.kiro/steering/Always/MainRules.md`
- **设计模式文件**: `AISpace/.kiro/steering/Always/DesignPatterns.md`
