...
<layer_1_quick_start>
  <quick_reference>
    - **Target Path:** `C:\Godot\KiroWorkingSpace\.kiro\steering\Godot\`
...
<layer_2_detailed_guide>
  <api_reference>
    ...
    | :--- | :--- | :--- |
    | **Output Path** | `C:\Godot\KiroWorkingSpace\.kiro\steering\Godot\` | **MUST** be exact absolute path. |
...
<layer_3_advanced>
  <troubleshooting>
    <error symptom="Generated context file is ignored by Kiro workspace or fails to parse">
      ...
      <fix>Verify the file is saved exactly in `C:\Godot\KiroWorkingSpace\.kiro\steering\Godot\` and the first lines are strictly `--- \n inclusion: manual \n ---`.</fix>
    </error>
