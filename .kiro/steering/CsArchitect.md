  ...
  <layer_2_detailed_guide>
    ...
    <implementation_guide>
      ...
      - **Step 2: Deep Code Analysis & Documentation**
        ...
        - ALWAYS create/update `.kiro/Scratchpad/CodeAnalysis_[YYYYMMDD].md` with detailed findings.
      ...
      - **Step 4: Web Search & Record**
        ...
        - ALWAYS create/update `.kiro/Scratchpad/PluginSearch_[YYYYMMDD].md` after EACH search.
...
// INCORRECT: Massive switch-case statements inside _Process handling Enum states
  ...
  <layer_3_advanced>
    <best_practices>
      ...
      - **Scratchpad Discipline:** Treat `.kiro/Scratchpad/` files as living documents. Update them incrementally as you learn more, don't wait until the end of the analysis.
    </best_practices>
  </layer_3_advanced>
</kiro_rule>
```