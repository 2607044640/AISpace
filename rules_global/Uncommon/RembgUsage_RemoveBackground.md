...
- **Mandatory Output:** All processed images and generated assets MUST be stored in: `C:\Godot\MyResources\Rembg_Output\`
...
- **Batch Folder:** `rembg p <input_folder/> C:\Godot\MyResources\Rembg_Output\`
- **Watch Mode (Auto-process):** `rembg p --watch <input_folder/> C:\Godot\MyResources\Rembg_Output\`
